        ...
        function createAnimations(animation) {
            ...
            for (const elementId in animation.elements) {
                ...
                for (const valueAnimation of animation.elements[elementId]) {
                    ...
                    const newAnimation = animateStyle(element, valueName, keyframes, Object.assign(Object.assign({}, options), { easing,
                        offset, repeat: options.repeat === "Infinity" ? Infinity : options.repeat, record: false }))();
