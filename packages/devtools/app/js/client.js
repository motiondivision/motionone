...
function handleRecordedAnimations() {
     ...
     */
    store.subscribe((recordedAnimations) => {
        if (!recordedAnimations)
            return;
...
function getDevTools() {
    const clientStore = window.__MOTION_DEV_TOOLS;
    if (clientStore)
        return clientStore.getState();
}
function animateStyle(element, key, keyframesDefinition, options = {}) {
    const devTools = getDevTools();
    const isRecording = options.record !== false && (devTools === null || devTools === void 0 ? void 0 : devTools.isRecording);
    let animation;
    ...
    return () => {
        ...
        if (isRecording) {
            devTools === null || devTools === void 0 ? void 0 : devTools.recordAnimation(element, key, keyframes, {
                duration,
                delay,
                easing,
                repeat,
...
function handleInspectedAnimation() {
    ...
    function createAnimations(animation) {
        ...
        for (const elementId in animation.elements) {
            ...
            for (const valueAnimation of animation.elements[elementId]) {
                ...
                const newAnimation = animateStyle(element, valueName, keyframes, Object.assign(Object.assign({}, options), { record: false }))();
    ...
    store.subscribe((currentTime) => {
        if (currentTime === undefined)
            return;
        scrubTo(currentTime);
    }, (state) => { var _a; return (_a = state.inspectedAnimation) === null || _a === void 0 ? void 0 : _a.currentTime; });
    store.subscribe((isRecording) => {
